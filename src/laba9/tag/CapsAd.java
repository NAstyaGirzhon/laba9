...
import laba9.entity.User;
import laba9.helper.AdListHelper;
public class CapsAd extends SimpleTagSupport {
...
// Если ошибки не было - to upper case
        if (errorMessage==null) {

            ad.setBody(ad.getBody().toUpperCase());//это для текста объявы
